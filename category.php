	...
	<div class="page-holder">
		...
		<div class="container">
			...
			<div class="container">
				...
				<div class="col-lg-6">
					<h1 class="h2 text-uppercase mb-0"><a href="index.php"
						class="nd">商店</a> / <?=$current_category['name']?></h1>
				</div>
			...
			<div class="container p-0">
				...
				<div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
					...
					<div class="col-lg-6 mb-2 mb-lg-0">
						<p class="text-sm text-muted mb-0">Showing 1–<?=$i?> of <?=$i?> results</p><!-- 這邊需要改!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
					</div>
					<div class="col-lg-6">
